...
public class MenuCardUI : MonoBehaviour
{
    ...
    [SerializeField] private List<IngredientUI> m_IngredientIcons = new();
    ...
    public void Set(Dish dish)
    {
        ...
        for (int i = 0; i < m_IngredientIcons.Count; i++)
        {
            ...
            {
                m_IngredientIcons[i].SetImage(dish.m_Ingredients[i].IngredientIcon);
    ...
    {
        foreach (IngredientUI i in m_IngredientIcons)
        {
